...
var BaseUnit = /** @class */ (function (_super) {
    ...
    BaseUnit.prototype.postponeAction = function () {
        this.postponedAction = true
    }
    BaseUnit.prototype.update = function (map) {
        var _this = this
        if (this.forceUpdate) {
        ...
        var currentSpeed = this.velocity.modulate(this.position, map)
        this.actions = this.actions.reduce(function (acc, action) {
            switch (action.type) {
                case UnitAction_1.UnitActionType.Move:
                    var isDestinationReached = _this.position.move(action.data.destination, currentSpeed)
    ...
    BaseUnit.prototype.getPublicState = function () {
        return {
            id: this.id,
            hp: this.life.getHP(),
