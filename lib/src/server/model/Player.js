...
var AbstractPlayer = /** @class */ (function () {
    ...
    AbstractPlayer.prototype.getUnitsState = function () {
        var _this = this;
        return xyMapToArray_1.xyMapToArray(this.units).map(function (unit) { return ({
            id: unit.id,
            type: unit.type,
            hp: unit.life.get(),
    ...
    AbstractPlayer.prototype.unitAction = function (action) {
        var unit = xyMapToArray_1.xyMapToArray(this.units).find(function (unit) { return unit.id === action.unitId; });
        if (unit) {
