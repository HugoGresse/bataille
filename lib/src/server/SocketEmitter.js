...
var SocketEmitter = /** @class */ (function () {
    ...
    SocketEmitter.prototype.emitGameUpdate = function (game) {
        return __awaiter(this, void 0, void 0, function () {
            var gameState, deltas, socketIds
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        gameState = game.getState()
                        deltas = this.diffPatcher.diff(this.lastGameState, gameState)
                        return [4 /*yield*/, this.sockets.allSockets()]
                    case 1:
                        socketIds = _a.sent()
                        socketIds.forEach(function (socketId) {
                            io_1.socketIOServer.to(socketId).emit(SOCKET_EMIT_1.GAME_STATE_UPDATE, {
                                deltas: deltas,
                                currentPlayer: game.getPlayerPrivateState(socketId),
                            })
                        })
