...
var SocketEmitter = /** @class */ (function () {
    ...
    SocketEmitter.prototype.emitInitialGameState = function (game) {
        this.sockets.emit(SOCKET_EMIT_1.GAME_STATE_INIT, game.export());
    };
    SocketEmitter.prototype.emitGameUpdate = function (game) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sockets.allSockets()];
                    case 1:
                        socketIds = _a.sent();
                        socketIds.forEach(function (socketId) {
                            io_1.socketIOServer.to(socketId).emit(SOCKET_EMIT_1.GAME_STATE_UPDATE, game.getState(socketId));
                        });
                        return [2 /*return*/];
                }
            });
