...
var Game = /** @class */ (function () {
    ...
    Game.prototype.start = function () {
        ...
        setTimeout(function () {
            ...
            Object.keys(_this.players).forEach(function (socketId) {
                // noinspection JSIgnoredPromiseFromCall
                _this.emitter.emitMessageToSpecificPlayer(
                    'You are playing as ' + _this.players[socketId].name,
                    socketId,
                    _this.players[socketId]
                )
            })
        }, 1500)
    }
    ...
    Game.prototype.getConnectedPlayers = function () {
